...
<style>
/* Темная тема в стиле Telegram для страницы входа */
...
.dark-theme a[href="/register.php"] {
    color: #5D93B5 !important;
}

.dark-theme a[href="/register.php"]:hover {
    color: #7ab0d3 !important;
}
...
/* Дополнительные улучшения для формы входа */
@media (prefers-color-scheme: dark),
.dark-theme {
    .feed {
