...
const questions = {
    general: [
        ...
        {
            question: "Какое животное обладает самым сильным укусом относительно размеров тела?",
            answers: ["Гиена", "Крокодил", "Тигровая акула", "Муравей-пуля"],
            correct: 3
        },
        {
            question: "Какой язык программирования высокого уровня был создан первым?",
            answers: ["Язык Ассемблера", "Fortran", "C", "COBOL"],
            correct: 1
        },
        {
            question: "Какой материк является самым сухим на Земле?",
            answers: ["Австралия", "Антарктида", "Африка", "Южная Америка"],
            correct: 1
        },
        {
            question: "Какое самое глубокое озеро в мире?",
            answers: ["Каспиское море", "Танганьика", "Байкал", "Виктория"],
            correct: 2
        },
        {
        ...
        },
        {
            ...
            answers: ["Сердце", "Печень", "Мозг", "Почки"],
            correct: 1
        },
        {
            question: "Какой самый распространённый элемент во Вселенной?",
            answers: ["Кислород", "Углерод", "Водород", "Железо"],
            correct: 2
        }
    ...
    science: [
        ...
        },
        {
            ...
            answers: ["Луи Пастер", "Александр Флеминг", "Роберт Кох", "Илья Мечников"],
            correct: 1
        },
        {
            question: "Как называется процесс деления обычной клетки?",
            answers: ["Митоз", "Мейоз", "Кроссинговер", "Осмоз"],
            correct: 0
        },
        {
            question: "Какой химический элемент обозначается как 'Hg'?",
            answers: ["Хингертум", "Герцогиний", "Ртуть", "Свинец"],
            correct: 2
        },
        {
            question: "Как называется самая тяжелая частица в атоме?",
            answers: ["Электрон", "Протон", "Нейтрон", "Кварк"],
            correct: 2
        },
        {
            question: "Что из этого является нуклоном",
            answers: ["Протон", "Электрон", "Фотон", "Бета-частица"],
            correct: 0
        },
        {
            question: "Какой газ вызывает парниковый эффект?",
            answers: ["Кислород", "Азот", "Углекислый газ", "Азон"],
            correct: 2
        },
        {
            question: "Какой прибор измеряет атмосферное давление?",
            answers: ["Барометр", "Психометр", "Хорометр", "Гигрометр"],
            correct: 0
        },
        {
            question: "Какой белок отвечает за свёртываемость крови?",
            answers: ["Гемоглобин", "Коллаген", "Фибриноген", "Кератин"],
            correct: 2
        },
        {
            question: "Какое явление объясняет радугу?",
            answers: ["Дифракция", "Дисперсия", "Интерференция", "Поляризация"],
            correct: 1
        }
    ],
    history: [
        ...
        },
        {
            ...
            answers: ["Томас Джефферсон", "Джордж Вашингтон", "Авраам Линкольн", "Бэнджамин Франклин"],
            correct: 1
        },
        {
            question: "Кто написал 'Капитал'?",
            answers: ["Фридрих Энгельс", "Карл Маркс", "Владимир Ленин", "Макс Вебер"],
            correct: 1
        },
        {
            question: "Какой император правил во время Отечественной войны 1812 года?",
            answers: ["Павел I", "Александр I", "Николай I", "Александр II"],
            correct: 1
        },
        {
        ...
        },
        {
            ...
            answers: ["Ленардо да Винчи", "Иоган Гутернберг", "Галилео Галилей", "Никола Тесла"],
            correct: 1
        },
        {
            question: "Как звали одного из составителей 'Повести временных лет'",
            answers: ["Кирилл", "Нектарий", "Аврахим", "Нестор"],
            correct: 3
        }
    ...
    movies: [
        ...
        },
        {
            ...
            answers: ["Крис Эванс", "Роберт Дауни-мл", "Крис Хэмсворд", "Марк Руффало"],
            correct: 1
        },
        {
            question: "Какой фильм выиграл 'Оскар' за лучший фильм в 2020 году?",
            answers: ["1917", "Паразиты", "Джокер", "Однажды в Голливуде"],
            correct: 1
        },
        {
            question: "Кто озвучивал Шрека в оригинале?",
            answers: ["Эдди Мерфи", "Майк Майерс", "Кэмерон Диаз", "Антонио Бандерас"],
            correct: 1
        },
        {
            question: "Какой фильм считается первым полнометражным анимационным?",
            answers: ["Бэмби", "Белоснежка и семь гномов", "Пиноккио", "Русалочка"],
            correct: 1
        },
        {
            question: "Какой режиссёр снял 'Начало' ('Inception')?",
            answers: ["Джеймс Кэмерон", "Кристофер Нолан", "Дэвид Финчер", "Ридли Скотт"],
            correct: 1
        },
        {
            question: "Кто является самым молодым режиссером, получившим Оскар",
            answers: ["Дэмьен Шазал", "Мартин Скорсезе", "Стэнли Кубрик", "Стивен Спилберг"],
            correct: 0
        },
        {
            question: "Какой композитор имеет наибольшее число номинаций на Оскар",
            answers: ["Эннио Мариконе", "Ханс Циммер", "Алан Манкен", "Джон Уильямс"],
            correct: 3
        },
        {
            question: "Сколько на данный момент вышло официальных продолжений франшизы Пила",
            answers: ["11", "8", "10", "7"],
            correct: 2
        },
        {
            question: "Кто является режиссером фильмов 'Ла-ла-ленд' и 'Одержимость'",
            answers: ["Крисс Миллер", "Фил Лорд", "Дэмьен Шазал", "Андрес Мускетти"],
            correct: 2
        },
        {
            question: "За роль в каком фильме Леонардо ДиКаприо получил Оскар",
            answers: ["Выживший", "Титаник", "Волк с Уолл-Стрит", "Начало"],
            correct: 0
        },
        {
            question: "Про какого миллионера НЕ сняли фильм?",
            answers: ["Марк Цукерберг", "Стив Джобс", "Илон Маск", "Джек Дорси"],
            correct: 3
        }
    ]
};
